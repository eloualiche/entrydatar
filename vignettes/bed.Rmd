...
Downloads data from the BED website. Of main importance is the flat file with firm level count by industry (3 digits naics) every quarter. This [page](http://www.bls.gov/bdm/bdmind3.htm) includes all the individual industry tables and the flat file is at the bottom under this [url](http://www.bls.gov/web/cewbd/bd_data_ind3.txt).
...
```{r, eval = F}
> get_bed("industry", level = T) %>% data.table
