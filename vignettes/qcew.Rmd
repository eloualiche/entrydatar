...
I included an option to specify a snapshot of the data take through the url wayback machine: thanks To [Gabriel Chodorow-Reich](http://scholar.harvard.edu/chodorow-reich) for suggesting the idea.[^1].
...
---------------------------
[^1]: The `stata` version of this code is on Gabe's website [here](http://scholar.harvard.edu/chodorow-reich/data-programs)
